...
export const TechArchitectureGraphic: React.FC = () => {
  return (
    <div className="relative w-full max-w-xl mx-auto">
      ...
      <div className="absolute -inset-1.5 rounded-3xl bg-gradient-to-r from-orange-400/20 via-slate-200 to-orange-500/20 blur-lg opacity-70" />
      ...
      <div className="relative bg-white border border-slate-200/90 rounded-2xl p-6 shadow-xl backdrop-blur-xl space-y-5">
        ...
        <div className="flex items-center justify-between pb-4 border-b border-slate-100">
          ...
          <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-700 text-[11px] font-mono font-semibold">
        ...
        <div className="grid grid-cols-3 gap-3">
          ...
          <div className="bg-slate-50 border border-slate-200 rounded-xl p-3.5 flex flex-col items-start gap-2 hover:border-orange-500/50 transition-colors group">
            <div className="w-9 h-9 rounded-lg bg-orange-100 border border-orange-200 flex items-center justify-center text-orange-600 group-hover:scale-105 transition-transform">
        ...
        <div className="relative bg-slate-900 text-white rounded-xl p-4 space-y-3 font-mono text-xs shadow-inner">
          <div className="flex items-center justify-between border-b border-slate-800 pb-2">
            ...
            <span className="text-[10px] text-orange-400 font-semibold">99.9% Uptime</span>
          </div>
          ...
          <div className="space-y-2 text-[11px]">
            ...
            <div className="flex items-center justify-between p-2 rounded bg-slate-800/80 border border-slate-700">
              ...
              <span className="text-orange-400 font-mono text-[10px]">Connected</span>
            </div>
            ...
            <div className="flex items-center justify-between p-2 rounded bg-slate-800/80 border border-slate-700">
              ...
              <span className="text-sky-400 font-mono text-[10px]">Active</span>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 pt-1 text-center">
          <div className="bg-orange-50 border border-orange-200 rounded-lg py-2.5">
            <span className="block text-xs font-bold text-slate-900 font-sans">Tailored Software</span>
            <span className="text-[10px] text-orange-700 font-semibold">Built Around Your Business</span>
          </div>
          <div className="bg-slate-50 border border-slate-200 rounded-lg py-2.5">
            ...
            <span className="text-[10px] text-slate-600 font-semibold">Tamil Nadu & Global Reach</span>
          </div>
        </div>
